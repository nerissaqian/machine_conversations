    ...
    // letters
      ...
      if (echo_stage == 3) {
        ...
        if (echoComplete == false) {
          ...
          echo_guide.guideDisplay(4, "", "Poem complete.", "Experiment concluded.", "", "Echo, signing off.", "");
          echo_guide.guideMove();
          echo_guide.guidehover();
...
function mousePressed() {
  if (slide == -1) {
    ...
    if (eris_stage == 2) {
      eris_DarkCounter = 0;
      eris_speechStage++;
      if (eris_speechStage > 2) eris_stage = 3;
    }
